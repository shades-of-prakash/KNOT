...
import CommentInput from "./CommentInput"; // 🔹 Add this import
...
const CommentPost = () => {
	...
	return (
		<div className="block w-full h-full">
			<div className="w-full h-auto font-pop bg-black border border-white/10 p-4 rounded-xl shadow-md space-y-3">
